defmodule UtilsWeb.Router do
  ...
  scope "/", UtilsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{UtilsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", UtilsWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{UtilsWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", UtilsWeb do
    ...
    live_session :current_user,
      on_mount: [{UtilsWeb.UserAuth, :mount_current_user}] do
